...
IDENTITY_TYPE=(
("national_id_card","Natonal ID Card"),
...
class Account(models.Model):
    ...
    account_number = ShortUUIDField(unique=True,length=10, max_length=25, prefix="207", alphabet="1234567890") #2175893745837
    account_id = ShortUUIDField(unique=True,length=7, max_length=25, prefix="RR", alphabet="1234567890") #2175893745837
...
class KYC(models.Model):
    ...
    pin_code=ShortUUIDField(length=6, max_length=8, alphabet="1234567890")
